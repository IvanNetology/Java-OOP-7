...
class TicketManagerTest {
    ...
    private Ticket ticket1 = new Ticket(1, 8300, "DME", "NOZ", 250);
    private Ticket ticket2 = new Ticket(2, 3500, "VKO", "SIP", 120);
    private Ticket ticket3 = new Ticket(3, 7500, "DME", "NOZ", 230);
    private Ticket ticket4 = new Ticket(4, 27500, "SVO", "NYS", 420);
    private Ticket ticket5 = new Ticket(5, 8000, "DME", "NOZ", 240);
